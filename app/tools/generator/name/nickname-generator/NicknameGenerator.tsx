...
const DEFAULT_TOOL_URL  = `${Config.MAIN_DOMAIN_NO}/tools/generator/name/nickname-generator`;
const DEFAULT_TOOL_NAME = "Nickname Generator";
...
function NicknameSection({ defaultStyle = "any" as Style }: { defaultStyle?: Style }) {
  ...
  return (
    <section id="generator" className="converter-preview" aria-labelledby="generator-h2">
      <div className="converter-container">
        <h2 id="generator-h2" className="converter-h2">Nickname Generator</h2>
...
export default function NicknameGeneratorPage({
  ...
  heroTitle = "Nickname Generator",
  heroEm = "find your perfect handle.",
  heroSub = "Generate unique, creative nicknames for games, social media, Discord, and any platform. Get 6 options at once, pick your favourite, copy in one click. No signup, no ads.",
  heroMeta = "Live API · 6 at a time · No Signup",
  faq = DEFAULT_FAQ,
  defaultStyle = "any",
  breadcrumbs,
}: NicknameGeneratorProps = {}) {
  const resolvedBreadcrumbs = breadcrumbs ?? [
    { name: "Home", item: Config.MAIN_DOMAIN_NO },
    { name: "Tools", item: `${Config.MAIN_DOMAIN_NO}/tools` },
    { name: toolName, item: toolUrl },
  ];
  ...
  const softwareAppJsonLd = {
    ...
    description: `Free ${toolName}. Get unique, creative names instantly. No signup, 100% free.`,
  ...
  const breadcrumbJsonLd = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    itemListElement: resolvedBreadcrumbs.map((b, i) => ({
      "@type": "ListItem",
      position: i + 1,
      name: b.name,
      ...(b.item ? { item: b.item } : {}),
    ...
    <>
      ...
      <section className="hero" aria-labelledby="hero-h1">
        <div className="hero-meta">
          <span className="dot dot-live" /> {heroMeta}
        </div>
      ...
      {/* TOOL */}
      <NicknameSection defaultStyle={defaultStyle} />

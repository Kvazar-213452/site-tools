...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${Config.MAIN_DOMAIN_NO}/tools/generator/random-question-generator` },
  openGraph: {
    ...
    url: `${Config.MAIN_DOMAIN_NO}/tools/generator/random-question-generator`,
    type: "website",
